...
# value is current here. The whole list places the Up and Down buttons.
apply_file_selection "$OMC_ACTIONUI_TABLE_10_COLUMN_3_VALUE" "$OMC_ACTIONUI_TABLE_10_COLUMN_3_ALL_ROWS"
